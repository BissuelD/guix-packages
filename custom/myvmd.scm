        ...
        (modify-phases %standard-phases
          (add-after 'unpack 'post-unpack
            (lambda* (#:key outputs inputs #:allow-other-keys)
              ...
              (define curr-dir (getenv "PWD"))
              (invoke "echo" "dotsdotsdots")
              (display curr-dir)
              ...
              ;(setenv "VMDINSTALLBINDIR" (string-append curr-dir "/bin"))
              ;(setenv "VMDINSTALLLIBRARYDIR" (string-append curr-dir "/lib"))
              ;(setenv "PLUGINDIR" (string-append curr-dir "/include/compiled-plugins"))
              (chdir "../vmd-1.9.4a57")
              (invoke "mv" "../plugins" ".")    
